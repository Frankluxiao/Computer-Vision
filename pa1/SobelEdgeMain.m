...
G_threshold2(G_origin < 100) = 0;

G_threshold3 = G_origin;
G_threshold3(G_origin < 230) = 0;



%% Expansion
G_expand = Expansion(G_threshold3, Threshold);
...
subplot(1,4,3);
imshow(G_threshold2); title('Edge with Manual-threshold = 100');
subplot(1,4,4);
imshow(G_threshold3); title('Edge with Manual-threshold = 230');
